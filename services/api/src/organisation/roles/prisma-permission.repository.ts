...
@Injectable()
export class PrismaOrganisationPermissionRepository
extends OrganisationPermissionRepository {
...
const record =
await this.database.organisationPermission.create({
...
const records =
await this.database.organisationPermission.findMany({
