...
@Injectable()
export class PrismaOrganisationVerificationRepository
extends OrganisationVerificationRepository {
...
private map(
record:any,
):OrganisationVerificationEntity {
...
const record =
await this.database.organisationVerification.create({
...
const record =
await this.database.organisationVerification.findUnique({
...
const record =
await this.database.organisationVerification.update({
