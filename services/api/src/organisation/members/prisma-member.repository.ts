...
@Injectable()
export class PrismaOrganisationMemberRepository
extends OrganisationMemberRepository {
...
const record =
await this.database.organisationMember.create({
...
const records =
await this.database.organisationMember.findMany({
